...
public void OnPluginStart()
{
	...
	HookEventEx("weapon_fire", Player_ThrowNade);
...
public void Player_ThrowNade(Event event, const char[] name, bool dontBroadcast) //http://world-source.ru/forum/100-2253-2#21682
{
	int client = GetClientOfUserId(event.GetInt("userid"));
	...
	char sWeapon[13];
	event.GetString("weapon", sWeapon, 13);
	
	if(strcmp(sWeapon, "hegrenade", false) == 0 || strcmp(sWeapon, "flashbang", false) == 0 || strcmp(sWeapon, "smokegrenade", false) == 0)
	{
		gA_Timers[client].iNades++;
	}
}
...
bool LoadMessages()
{
	...
	kv.GetString("green", gS_ChatStrings.sGreen, sizeof(chatstrings_t::sGreen), "\x0700ff00");
	kv.GetString("dimgray", gS_ChatStrings.sDimgray, sizeof(chatstrings_t::sDimgray), "\x07696969");
	kv.GetString("orange", gS_ChatStrings.sOrange, sizeof(chatstrings_t::sOrange), "\x07ffa500");
