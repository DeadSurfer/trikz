...
public Action Timer_PrintToChat(Handle Timer)
{
	...
	else
	{
		switch(timeleft)
		{			
			case 182: Shavit_PrintToChatAll("%sVote will start in %s3 %ssecond.", gS_ChatStrings.sText, gS_ChatStrings.sOrange, gS_ChatStrings.sText);
			case 181: Shavit_PrintToChatAll("%sVote will start in %s2 %ssecond.", gS_ChatStrings.sText, gS_ChatStrings.sOrange, gS_ChatStrings.sText);
			case 180: Shavit_PrintToChatAll("%sVote will start in %s1 %ssecond.", gS_ChatStrings.sText, gS_ChatStrings.sOrange, gS_ChatStrings.sText);
